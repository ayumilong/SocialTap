define([
	...
	domUtil, domClass, domGeometry, domStyle, query, manager, Widget, TemplatedMixin, declare) {

kernel.experimental("app.vis.AccordionResizeHandle");

var ResizeHandle = declare("app.vis.ResizeHandle",[Widget, TemplatedMixin],
	{
	// summary:
	...
	_changeSizing: function(/*Event*/ e){
		...
		if(isWidget){
			...
			if(this.animateSizing){
				...
				var nodes = query("." + this.targetId);
				var i;
				for (i = 0; i < nodes.length; i++) {
					domStyle.set(nodes[i],{
						width: tmp.w + "px"
						//height: tmp.h + "px"
					});
				}
