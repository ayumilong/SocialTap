define([
	...
	"dijit/_Container",
	"dijit/_WidgetBase",
	"app/vis/AccordionResizeHandle",
	"dojox/mobile/iconUtils",
	"dojox/mobile/lazyLoadUtils",
	"dojox/mobile/_css3",
	"require",
	"dojo/has!dojo-bidi?dojox/mobile/bidi/Accordion"
], function(array, declare, lang, has, locale, dom, domClass, domConstruct, domAttr, domStyle, Contained, Container, WidgetBase, ResizeHandle, iconUtils, lazyLoadUtils, css3, require, BidiAccordion){
	...
	var _AccordionTitle = declare([WidgetBase, Contained], {
		// summary:
		//		A widget to display some information about the data item in
		//		the titlebar.
		...
		buildRendering: function(){
			...
			this.UsernameNode = domConstruct.create("div", {
				"class" : "mblAccordionTitleTextbox accordionColumnUsername",
				"style" : "width:" + domStyle.get("accordionColumnUsername", "width") + "px",
				innerHTML: this._cv ? this._cv(this.label) : this.label
			}, this.textBoxNode);
			this.BodyNode = domConstruct.create("div", {
				"class" : "mblAccordionTitleTextbox accordionColumnBody",
				"style" : "width:" + domStyle.get("accordionColumnBody", "width") + "px",
				innerHTML: this.data.body
			}, this.textBoxNode);
			this.DateNode = domConstruct.create("div", {
				"class" : "mblAccordionTitleTextbox accordionColumnDate",
				"style" : "width:" + domStyle.get("accordionColumnDate", "width") + "px",
				innerHTML: this.dateFormat(this.data.postedTime, "MMM d, yyyy")
			}, this.textBoxNode);
	...
	var Accordion = declare(has("dojo-bidi") ? "dojox.mobile.NonBidiAccordion" : "dojox.mobile.Accordion", [WidgetBase, Container, Contained], {
		...
		buildRendering: function(){
			...
			// Container for Label
			var accLabel = domConstruct.create("div", {
				className: "mblAccordionLabelBox"
			}, this.domNode);
			...
			this.UsernameLabel = domConstruct.create("div", {
				"id": "accordionColumnUsername",
				"class" : "mblAccordionLabel accordionColumnUsername",
				innerHTML: "<b>Username</b>"
			}, a);
			this.UsernameHandleBox = domConstruct.create("div", {
				className: "mblAccordionResizeHandle"
			}, this.UsernameLabel);
			this.UsernameHandle = new ResizeHandle({
				targetId: "accordionColumnUsername",
				minWidth: 200
			}, this.UsernameHandleBox);

			// Creates Body Label
			this.BodyLabel = domConstruct.create("div", {
				"id" : "accordionColumnBody",
				"class" : "mblAccordionLabel accordionColumnBody",
				innerHTML: "<b>Body</b>"		
			}, a);
			this.BodyHandleBox = domConstruct.create("div", {
				className : "mblAccordionResizeHandle"
			}, this.BodyLabel);
			this.BodyHandle = new ResizeHandle({
				targetId: "accordionColumnBody",
				minWidth: 200
			}, this.BodyHandleBox);	

			// Creates Date Label
			this.DateLabel = domConstruct.create("div", {
				"id" : "accordionColumnDate",
				className: "mblAccordionLabel accordionColumnDate",
				innerHTML: "<b>Date</b>"
			}, a);
			this.DateHandleBox = domConstruct.create("div", {
				className: "mblAccordionResizeHandle"
			}, this.DateLabel);
			this.DateHandle = new ResizeHandle({
				targetId: "accordionColumnDate",
				minWidth: 150
			}, this.DateHandleBox);	
		},
